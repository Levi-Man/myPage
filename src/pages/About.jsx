      ...
      <div className="about-container">
        <div className="about-me">
          <p>
            ...
            <span>🎓 Recent Full Stack Bootcamp Graduate (2023-2024):</span>
            <br></br> I recently completed a Full Stack Bootcamp under the University of Toronto, where I honed my skills in web development and acquired proficiency in various technologies and methodologies.<br></br>
        ...
        <div className="image"><img id="self-portrait" src="/self.jpg" alt="Photo of Indra holding a glowing egg"></img>
        </div>
      </div>
    </div>
  );
